        ...
        translateState.setOnCheckedChangeListener((buttonView,isChecked) ->{
            ...
            if(isChecked){
                ...
                new AlertDialog.Builder(this).
                        setTitle("Use Translator")
                        .setMessage("This may increase data charges initially. Continue ?")
                        .setPositiveButton("Yes",(dialog, which)-> {
                            useTranslator=true;
                        }).setNegativeButton("Cancel", (dialog, which)->{useTranslator=false;translateState.setChecked(false);}).create().show();
            }
